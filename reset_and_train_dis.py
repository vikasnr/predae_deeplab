...
from predAE import train_gan_discriminator_only
...
#Create the models (we do not reset the generator!)
...
train_gan_discriminator_only(gan_model, train_ds, n_epochs=NE)       
