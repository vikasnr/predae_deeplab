...
class DeepLabV3(nn.Module):
    def __init__(self, model_id, project_dir):
        ...
        self.aspp = ASPP(num_classes=self.num_classes) # NOTE! if you use ResNet50-152, set 
    ...
    def forward(self, x):
        ...
        h = x.size()[2]
        w = x.size()[3]
        # x.shape  [1, 3, 256, 256]  --resnet
        # x.shape [3, 3, 256, 256]  --wideset
        ...
        #resnet_18 torch.Size([1, 512, 32, 32])  , [1, 512, 64, 128]
        # [3, 2048, 32, 32] --WideResNet()
        output = self.aspp(feature_map) # (shape: (batch_size, num_classes, h/16, w/16))
        # 3, 20, 32, 32 , ([1, 20, 64, 128])--resnet
